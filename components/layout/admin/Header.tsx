...
import { FaCaretRight, FaSearch, FaSortDown } from "react-icons/fa";
            ...
            return (
              <div className="group relative" key={index}>
                <Link
                  ...
                  className="flex gap-2 items-center group font-light hover:bg-gray-100 h-max py-2 px-5  rounded-md"
                >
                  <Icon />
